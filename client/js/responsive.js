/**
 * - desktop--scale-fit (kurs, страницы курсов): макет 1920×1080, вписать в окно
 * - desktop--scale-adaptive (account): 100vw×100vh, при узком окне — уменьшение scale
...
(function () {
  ...
  /** kurs + страницы курсов: фиксированный холст 1920×1080, вписать в окно */
  ...
  /** account: оригинальный 100vw×100vh + scale при необходимости */
